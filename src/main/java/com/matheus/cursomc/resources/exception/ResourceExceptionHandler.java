...
public class ResourceExceptionHandler {
    @ExceptionHandler(ObjectNotFoundtException.class)
    public ResponseEntity<StandardError> objectNotFound(ObjectNotFoundtException e, HttpServletRequest request) {
